...
<body>
    ...
    <section class="container1 section3">
        <div class="newarrival productdetails">
            <h1><span class="shoescategory semibold">BEST SELLER</span></h1>
        </div>
    ...
    <script>
        ...
        const newArrivals = [
            {
                id: '010',
                image: 'photo/mancityjersey.png',  // Different image for Best Seller
                image_price: '$199',
                company: 'Puma',
        ...
        // Data for Best Seller (can be the same or different)
        const bestSellerItems = [
            {
                id: '019',
                image: 'photo/nike football.png',  // Different image for Best Seller
                image_price: '$98',
                company: 'Nike',
            ...
            {
                id: '004',
                image: 'photo/nike football1.png',  // Different image for Best Seller
                image_price: '$120',
                company: 'Nike',
            ...
            {
                id: '030',
                image: 'photo/socks.png',  // Different image for Best Seller
                image_price: '$10',
                company: 'Adidas',
                item_name: 'Adidas Football Long Socks',
            }
        ];
        ...
        // Insert Best Seller products into their section
        itemContainerElementBestSeller.innerHTML = generateItemsHTML(bestSellerItems);
