...
<body>
    ...
    <section class="container1 section3">
        <div class="newarrival productdetails">
            <h1><span class="shoescategory semibold">NEW ARRIVALS</span></h1>
        </div>
    ...
    <script>
        ...
        const bestSellerItems = [
            {
                id: '013',
                image: 'photo/arsenaljersey.png',  // Different image for Best Seller
                image_price: '$109',
                company: 'Adidas',
            ...
            {
                id: '015',
                image: 'photo/realjersey.png',  // Different image for Best Seller
                image_price: '$105',
                company: 'Adidas',
